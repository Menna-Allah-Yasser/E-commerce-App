...
public class Bata extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>  {
   ...
   // first of all we will get the views that are  present in the layout of info
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shoeName.setText("Bata");
        descdescription.setText(R.string.bata);
        imageView.setImageResource(R.drawable.bata);


        buyit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Bata.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(Bata.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int shoePrice = basePrice * quantity;
